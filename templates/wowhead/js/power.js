...
var Icon = {
    ...
    setTexture: function (d, c, b) {
        ...
        if (b.indexOf("?") != -1) {
            ...
            a.backgroundImage = "url(https://classicwow.info" + Icon.sizes[c] + "/" + b.toLowerCase() + ".jpg)"
        }
...
var Tooltip = {
    ...
    setIcon: function (a) {
        Tooltip.prepare();
        if (a) {
            Tooltip.icon.style.backgroundImage = "url(https://classicwow.info/images/icons/medium/" + a.toLowerCase() + ".jpg)";
...
var $WowheadPower = new
    function () {
        ...
        function b(W, S, X, Q, T) {
            ...
            var P = "https://classicwow.info/ajax.php?" + p[W][1] + "=" + S + "&power" + R;
            g_ajaxIshRequest(P)
        }
        function N(R, S) {
            if (J._fixTooltip) {
        ...
        _link.href = "https://classicwow.info/templates/wowhead/css/power.css";
        _script.setAttribute("src","https://classicwow.info/templates/wowhead/js/locale_enus.js");
