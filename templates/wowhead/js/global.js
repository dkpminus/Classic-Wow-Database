...
function g_getForumLink(b, e, c) {
	...
	prompt(LANG.prompt_ingamelink,"[url='https:/classicwow.info/?item="+g_pageInfo.typeId+"'][color=#"+colour+"]"+g_pageInfo.name+"[/color][/url]")
};
...
function ss_appendSticky() {
	...
	if (k != -1) {
		...
		f.src = (c.wowhead==1 ? "https://wow.zamimg.com/uploads/screenshots/thumb/" : "images/screenshots/thumb/") + c.id + ".jpg";
		f.className = "border";
		ae(l, f);
		ae(m, l);
		var g = ce("div");
...
var Tooltip = {
	...
	fix: function (d, b, f, i, t) {
		...
		//if(t == 'item'){
		//	d.style.background = "url(https://static.wowhead.com/modelviewer/thumbs/item/" + i + ".png) 90% 5px no-repeat";
		//}
		//if(t == 'npc'){
//			d.style.background = "url(https://static.wowhead.com/modelviewer/thumbs/npc/" + i + ".png) 90% 5px no-repeat";
//		}
	},
...
Listview.templates = {
	...
	item: {
		...
		}/* ,
		{
			...
			compute: function (d, e) {
				...
				var b = ce("a");
				var c = Listview.funcBox.getItemType(d.classs, d.subclass, d.subsubclass);
				b.href = "https://www.wowhead.com/?item="+d.id";
				ae(b, ct(c.text));
				ae(e, b)
			}
		} */],
	...
	comment: {
		...
		compute: function (t, H) {
			...
			var G = ce("a");
			G.href = (t.wowhead == 1 ? "https://classicwow.info/user=" : "?user=") + t.user;
			ae(G, ct(t.user));
			ae(w, G);
			ae(w, ct(" "));
			var a = ce("a");
			...
			ae(w, a);
			ae(w, ct(LANG.lvcomment_patch1 + (t.wowhead == 1 ? g_getPatchVersion(s) : "1.12.1") + LANG.lvcomment_patch2));
			ae(H, w);
			...
			compute: function (j, i) {
				...
				if (e || f) {
					...
					if (f) {
						...
						var b = ce("a");
						b.href = (j.wowhead==1 ? "https://www.wowhead.com/user=" : "?user=") + j.user;
						ae(b, ct(j.user));
						ae(g, b);
						if (e) {
							ae(g, ct(LANG.hyphen))
	...
	screenshot: {
		...
		compute: function (k, e, l) {
			...
			v.src = (k.wowhead==1 ? "https://wow.zamimg.com/uploads/screenshots/thumb/" : "images/screenshots/thumb/") + k.id + ".jpg";
			ae(q, v);
			ae(e, q);
			var p = ce("div");
			...
			var a = (k.approved == 0);
				...
				q = ce("a");
				q.href = (k.wowhead==1 ? "https://www.wowhead.com/user=" : "?user=") + k.user;
				ae(q, ct(k.user));
	...
	model: {
		...
		appendFlash: function (a) {
			var c = {
				model: a.displayId,
				modelType: 8,
				contentPath: "https://static.wowhead.com/modelviewer/",
				blur: (OS.mac ? "0": "1")
			};
			var b = {
				quality: "high",
...
/* 			P = aa.rel.match(/(item|quest|spell|achievement|npc|object|profile).?([^&#]+)/) */
	...
	function b(W, S, X, Q, T) {
		...
		*/
		...
		if (R == "&wowhead=true")
		{
			P = "https://" + g_getDomainFromLocale(g_locale.id) + ".wowhead.com";
			P += "/" + p[W][1] + "=" + S + "&power";
			//P = "https://www.wowpedia.org/index.php?title=Sea_Turtle_(mount)&action=render";
		}
		//TODO: Wowpedia Tips
		/* if (R == "&wowpedia=true")
		{
			//P =
			P = "https://www.wowhead.com/item=57191&power";
		} */
...
function () {
	...
	function s(F) {
		...
		g(0);
		var E = (C.url ? C.url: (C.wowhead==1 ? "https://wow.zamimg.com/uploads/screenshots/" : "images/screenshots/") + (I ? "resized/": "normal/") + C.id + ".jpg");
		...
		if (!F) {
			if (C.url) {
				...
				h.href = (C.wowhead==1 ? "https://wow.zamimg.com/uploads/screenshots/normal/" : "images/screenshots/normal/") + C.id + ".jpg"
			}
			...
			if (L) {
				...
				M.href = (C.wowhead==1 ? "https://www.wowhead.com/user=" : "?user=") + C.user;
				M.innerHTML = C.user;
...
aowow.init = function(){
	...
	if(wh_model)
	{
		...
		//check = ge('modelv');
		//if(check)
		//ge('modelv').src = 'https://www.aowow.org/templates/wowhead/images/ajax_load_2.gif';
...
fb = ge("fb-like");
	fb.className = "header-facebook-like";
	//document.body.background = "templates/wowhead/images/bg_tbc_bot.jpg) center -200px no-repeat !important;";
}
aowow.func.loadmodel = function(){
	ge('modelv').src = 'https://classicwow.info/images/models/' + g_types[g_pageInfo.type] + '/' + wh_model + '.png';
}
